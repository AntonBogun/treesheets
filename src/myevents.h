...
BEGIN_EVENT_TABLE(treesheets::MyFrame, wxFrame)
  ...
  EVT_TEXT_ENTER(A_REPLACE, treesheets::MyFrame::OnReplaceEnter)
...
BEGIN_EVENT_TABLE(treesheets::TSCanvas, wxScrolledWindow)
  ...
  EVT_MOUSE_AUX1_DOWN(treesheets::TSCanvas::OnAux1Down)
  EVT_MOUSE_AUX2_DOWN(treesheets::TSCanvas::OnAux2Down)
